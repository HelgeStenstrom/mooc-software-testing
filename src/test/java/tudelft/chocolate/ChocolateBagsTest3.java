...
class ChocolateBagsTest3 {
    ...
    void testAlgorithm(String partition, int small, int big, int total, int expectedResult) {
        int result = new ChocolateBags().calculateNeededOnes(small, big, total);
